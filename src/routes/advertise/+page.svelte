...
<Seo
    title="פרסום באתר הרכישות הקבוצתיות — חשיפה לקהילה שקונה יחד"
    description="פרסום באתר הרכישות הקבוצתיות של יוצאים לחירות: מסלולי באנרים, פרסומת מסך-מלא בנייד ודף נחיתה לעסק. מעצבים את הפרסומת ישירות באתר, משלמים, והמודעה עולה אחרי אישור מנהל."
    path="/advertise"
    keywords="פרסום באתר, פרסום לעסקים, באנרים, פרסום מקומי, רכישות קבוצתיות"
/>
