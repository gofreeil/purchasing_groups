    ...
    he: {
        ...
        purchases: {
            cellular: {
                ...
                desc: "החל מ-15 ש\"ח לחודש, ללא התחייבות, ללא דמי הצטרפות, אפשרות לעבור חזרה או לספק אחר בכל עת",
                alt: "סלולר"
            },
            internet: {
        ...
        details: {
            ...
            steps: [
                { icon: "📝", title: "משאירים פרטים", desc: "מלאו טופס קצר עם פרטי התקשרות בסיסיים." },
                { icon: "🤝", title: "אנחנו מתחברים לספק", desc: "אנו דואגים שנציג החברה יתקשר אליכם ויתן לכם את תנאי הקבוצה!" },
