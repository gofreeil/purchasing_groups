// ============================================================
// adImageFit.js — מיקום + זום של התמונה הראשית בפרסומת
// ------------------------------------------------------------
...
// ה-fit נשמר עם המודעה (בתוך ה-JSON של landing, כמו שאר התוספות)
// ומוחל גם בתצוגות האמיתיות, כך שהדמו בבילדר הוא באמת "מה שרואים".
// ============================================================

/**
 * @typedef {Object} AdImageFit
 * @property {number} x
 * @property {number} y
 * @property {number} z
 */
...
/** @type {AdImageFit} */
export const DEFAULT_AD_FIT = { x: 50, y: 50, z: 1 };
 ...
 * @returns {AdImageFit}
 */
export function parseAdImageFit(raw) {
 ...
 * @param {AdImageFit} fit
 */
export function adImgFit(node, fit) {
    let current = fit;
