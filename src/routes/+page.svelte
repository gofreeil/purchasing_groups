<script>
    ...
    const CARD_CONFIG = {
        cellular: { rating: 5.0 },
        fuel: { rating: 4.9 },
        // ביטוח רכב - פעיל; החיסכון נקרא מעמודה K בגיליון (CAMPAIGN_COLS ב-+page.server.js).
        // כל עוד הגיליון מראה 0 שם - הכרטיס מציג 0 ש"ח, ויתעדכן לבד כשיהיו נתונים.
...
<style>
    ...
    @media (min-width: 1025px) {
        .survey-badge-container {
            left: 180% !important; /* Move even further right to avoid hiding savings data */
        }
    }
