...
export const translations = readable({
    he: {
        ...
        purchases: {
            ...
            fuel: {
                title: "הנחה בדלק!",
                desc: "הנחה של 31 אגורות על כל ליטר בנזין מהמחיר היציג של סונול. ניתן לממש ב-700 תחנות ברחבי הארץ של דור אלון, טן, תפוז וסונול!",
                alt: "דלק"
            },
            carInsurance: {
        ...
        details: {
            ...
            steps: [
                { icon: "📝", title: "השאירו פרטים", desc: "מלאו טופס קצר עם פרטי התקשרות בסיסיים." },
                { icon: "🤝", title: "אנחנו מתחברים לספק", desc: "אנו פועלים מול הספק להבטחת המחיר הקבוצתי." },
                { icon: "💸", title: "מתחילים לחסוך", desc: "מקבלים את המחיר המוזל ישירות בחשבונית החודשית." }
            ],
            ...
            faq: [
                ...
                { q: "האם המחיר מובטח לכל החיים?", a: "המחיר מובטח לתקופת ההתקשרות המוסכמת מול הספק, בדרך כלל לפחות שנתיים." },
