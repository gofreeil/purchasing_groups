<script>
    ...
    // ---- שלוש אפשרויות הפרסום באתר (כרטיסי מידע) ----
    const packages = [
        {
            name: "באנר צד ימין",
            icon: "📌",
            location: "מופיע בגרסת המחשב בכל עמודי האתר",
            features: ["חשיפה גבוהה בכל עמוד", "קהל צרכני ממוקד", "לינק לאתר שלך"],
        },
        {
            name: "כרטיס בסיידבר",
            icon: "🖼️",
            location: "לצד תוכן האתר במחשב",
            features: ["כרטיס עם תמונה מלאה", "טקסט נוסף בריחוף העכבר", "דף נחיתה אישי באתר"],
        },
        {
            name: "פרסומת בנייד",
            icon: "📱",
            location: "במגירת ההטבות בנייד",
            features: ["מופיע לכל גולשי הנייד", "כולל דף נחיתה", "קישור ישיר לעסק שלך"],
        },
    ];
...
<div class="advertise-page" dir="rtl">
    ...
    {:else}
        <div class="ap-empty-calc">
            <p>🧮 בחר את סוג הפרסום ותקופתו כדי לראות את <strong>סיכום המחיר!</strong></p>
        </div>
    {/if}
